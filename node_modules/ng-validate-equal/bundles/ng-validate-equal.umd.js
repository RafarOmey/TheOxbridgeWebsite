(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng-validate-equal', ['exports', '@angular/core', '@angular/forms'], factory) :
    (global = global || self, factory(global['ng-validate-equal'] = {}, global.ng.core, global.ng.forms));
    ...
    ***************************************************************************** */
    ...
    var ValidateEqualDirective = /** @class */ (function () {
        ...
        ValidateEqualDirective.ctorParameters = function () { return [
            { type: String, decorators: [{ type: core.Attribute, args: ['ngValidateEqual',] }] }
        ]; };
        ValidateEqualDirective = ValidateEqualDirective_1 = __decorate([
            core.Directive({
                selector: '[ngValidateEqual]',
                providers: [
                    { provide: forms.NG_VALIDATORS, useExisting: core.forwardRef(function () { return ValidateEqualDirective_1; }), multi: true }
                ]
            }),
            __param(0, core.Attribute('ngValidateEqual'))
